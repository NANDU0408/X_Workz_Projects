...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h2 class="text-center mb-4 mt-4">Department-Admin-Registration Form</h2>
            <form action="deptAdminReg" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="deptId" name="dept_id" onblur="deptIdValidation()">
                        ...
                        <c:forEach var="department" items="${addAdminDepartments}">
